...
type Location struct {
	...
	LocationName string             `json:"locationName,omitempty" bson:"locationName,omitempty"gorm:"column:locationName" validate:"required,max=255"`
	...
	Type         string             `json:"type,omitempty" bson:"type,omitempty" gorm:"column:type" validate:"required,max=40"`
	...
	Location     *mongo.Coordinates `json:"-" bson:"location,omitempty" gorm:"column:location"`
